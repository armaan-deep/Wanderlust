...
const {isLogin,isOwner,validateListing}= require("../module/middleware.js");
...
.post(isLogin,upload.single('list[image]'),validateListing,asyncWrap(listingController.newListing))
...
.put(isLogin,isOwner,upload.single('list[image]'),validateListing,asyncWrap(listingController.updateListing))
